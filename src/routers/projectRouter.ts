...
projectRouter.get('/project/:id', asyncHandler(ProjectController.getProjectDetail))
projectRouter.get('/projectByUser/:userid', asyncHandler(ProjectController.findProjectByUser))
